<?php
/**
 * Dot Object Syntax php
 * Author: Charl Cronje
 * Date: 2017-02-23
 * Description: person.hobbies:0.hobbyName" Equal to "$person->hobbies[0]->hobbyName"
 * But you can also store entire functions or classes in this structure
 */
